...
<!-- 		<input type="hidden" name="_csrf" value="RDB0NmpwNUx1RjFmWxV9Hxx7Hkw6IHc9G14WTg01fykDZx8BHBJmFg==" /> -->
		...
		<input type="text" id="post-title" class="form-control" name="Post[title]" maxlength="128" />
		...
		<textarea id="post-content" class="form-control" name="Post[content]" rows="6"></textarea>
...
<!-- 		<div class="form-group field-post-status required">
		...
		<div class="form-group">
		    <button type="submit" class="btn btn-success"> 新 增 </button>    </div>
